```
/ddw-threat-modeling docs/ddw/security/threat-FIX-001.md — PASSED
────────────────────────────────────────────────────────────────
  ✅ F-TM-01: all 6 STRIDE categories evaluated for 2 component(s)
  ✅ F-TM-02: trust boundaries are declared
  ✅ F-TM-03: all 1 identified threats carry a mitigation or an acceptance
